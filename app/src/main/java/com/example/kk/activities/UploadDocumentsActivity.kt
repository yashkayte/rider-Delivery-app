...
class UploadDocumentsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Optional: Load already uploaded docs (if user returns)
        loadExistingDocs()
    ...
    private fun uploadToFirebase(uri: Uri, index: Int) {
        ...
        val fileRef = storage.reference
            .child("riders/${user.uid}/${docItem.key}/${System.currentTimeMillis()}")
            ...
            .addOnSuccessListener {
                fileRef.downloadUrl
                    ...
                    .addOnFailureListener { e ->
                        ...
                        Toast.makeText(this, "URL error: ${e.message}", Toast.LENGTH_LONG).show()
                    }
            }
            .addOnFailureListener { e ->
                adapter.setUploading(index, false)
    ...
    private fun saveDocToFirestore(index: Int, url: String) {
        ...
        db.collection("riders")
            ...
            .addOnSuccessListener {
                ...
                Toast.makeText(this, "${docItem.title} uploaded ✅", Toast.LENGTH_SHORT).show()
            }
            .addOnFailureListener { e ->
                adapter.setUploading(index, false)
    ...
    private fun submitKyc() {
        ...
        db.collection("riders")
            .document(user.uid)
            .set(riderData, com.google.firebase.firestore.SetOptions.merge())
            .addOnSuccessListener {
                Toast.makeText(this, "Documents submitted ✅", Toast.LENGTH_SHORT).show()
                finish()
            }
            .addOnFailureListener { e ->
